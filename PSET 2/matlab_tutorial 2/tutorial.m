...
% convolution
%
% - 'conv' computes the one dimension convolution
% - 'conv2' computes a two dimension convolution
...
figure;
subplot(1,3,1); stem(input,'r'); axis([-1 12 -1.5 1.5]);
subplot(1,3,2); stem(kernel,'g');axis([-1 3 -1.5 1.5]);
subplot(1,3,3); stem(output,'b');axis([-1 13 -1.5 1.5]);
